...
import '../controller/readmeter_controller.dart';
...
class BottomElectricityBillPage extends StatefulWidget {
  const BottomElectricityBillPage({super.key});

  @override
  State<BottomElectricityBillPage> createState() =>
      _BottomElectricityBillPageState();
}

class _BottomElectricityBillPageState extends State<BottomElectricityBillPage> with WidgetsBindingObserver {
  ...
  final ReadMeterController readMetercontroller = Get.put(ReadMeterController());  int selectedIndex = 0;
  ...
  void didChangeDependencies() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      readMetercontroller.fetchMeterData();
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonMethods.sizedBox(height: 16.h),
                            Obx(() {
                              if (readMetercontroller.isLoading.value) {
                                return Container(
                                    height: 200.h,
                              ...
                              } else if (readMetercontroller.meters.isNotEmpty) {
                                return Column(
                                  children: [
                                    Column(
                                      children:
                                      readMetercontroller.meters.map((rowData) {
