...
class BuyElectricityBillPage extends StatefulWidget {
  const BuyElectricityBillPage({super.key});

  @override
  State<BuyElectricityBillPage> createState() => _BuyElectricityBillPageState();
}

class _BuyElectricityBillPageState extends State<BuyElectricityBillPage> with WidgetsBindingObserver {
