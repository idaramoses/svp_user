...
class TasksListItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, AppRoutes.tasksOneScreen);
      },
      child: Container(
...
class TasksListItemWidgetcomplete extends StatelessWidget {
...
class TasksListItemWidgetpending extends StatelessWidget {
